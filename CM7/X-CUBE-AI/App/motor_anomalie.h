/**
  ...
  ******************************************************************************
  */
#ifndef AI_MOTOR_ANOMALIE_H
#define AI_MOTOR_ANOMALIE_H

#include "motor_anomalie_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MOTOR_ANOMALIE_MODEL_NAME          "motor_anomalie"
#define AI_MOTOR_ANOMALIE_ORIGIN_MODEL_NAME   "motor_cnn_int8"

/******************************************************************************/
#define AI_MOTOR_ANOMALIE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MOTOR_ANOMALIE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MOTOR_ANOMALIE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MOTOR_ANOMALIE_IN_NUM        (1)

AI_DEPRECATED
#define AI_MOTOR_ANOMALIE_IN \
  ai_motor_anomalie_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MOTOR_ANOMALIE_IN_SIZE { \
  AI_MOTOR_ANOMALIE_IN_1_SIZE, \
}
#define AI_MOTOR_ANOMALIE_IN_SIZE_BYTES { \
  AI_MOTOR_ANOMALIE_IN_1_SIZE_BYTES, \
}
...
#define AI_MOTOR_ANOMALIE_IN_1_SIZE_BYTES  (180)

/******************************************************************************/
#define AI_MOTOR_ANOMALIE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MOTOR_ANOMALIE_OUT \
  ai_motor_anomalie_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MOTOR_ANOMALIE_OUT_SIZE { \
  AI_MOTOR_ANOMALIE_OUT_1_SIZE, \
}
#define AI_MOTOR_ANOMALIE_OUT_SIZE_BYTES { \
  AI_MOTOR_ANOMALIE_OUT_1_SIZE_BYTES, \
}
...
#define AI_MOTOR_ANOMALIE_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MOTOR_ANOMALIE_N_NODES (11)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup motor_anomalie
 ...
 * @ref ai_motor_anomalie_create. Both the activations memory buffer 
 ...
 * using @ref ai_motor_anomalie_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_motor_anomalie_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_motor_anomalie_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MOTOR_ANOMALIE_*
 * defines into file @ref motor_anomalie.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_motor_anomalie_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MOTOR_ANOMALIE_H */
